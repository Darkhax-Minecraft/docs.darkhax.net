...
description: Documentation for the Enchantment Descriptions mod for Minecraft 1.20.1.
sidebar:
  order: 0
---
...
![Enchantment descriptions being displayed on an enchanted sword.](https://docs.darkhax.net/assets/enchantment-descriptions/enchanted_item.png)
...
| style                        | \{"color":"dark_gray"\} | Sets the visual style of the description in game. Learn more about styles [here](/minecraft/concepts/text/style). |
...
[here](https://docs.darkhax.net/assets/enchantment-descriptions/Enchantment-Descriptions-Examples-1.0.0.zip). If you are
