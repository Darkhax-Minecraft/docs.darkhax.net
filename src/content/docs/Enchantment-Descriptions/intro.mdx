...
Enchantment Descriptions is a lightweight client side mod that demystifies enchantments by adding a description to the
tooltip of an enchanted item. Most modded enchantments are also supported!
