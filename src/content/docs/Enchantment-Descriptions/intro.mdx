...
file on <Link title="GitHub" ref="https://github.com/Darkhax-Minecraft/Enchantment-Descriptions/blob/1.20.1/common/src/main/resources/assets/enchdesc/lang/en_us.json"/>.
...
<Link text="here" ref="https://docs.darkhax.net/assets/enchantment_descriptions/Enchantment-Descriptions-Examples-1.0.0.zip"/>
