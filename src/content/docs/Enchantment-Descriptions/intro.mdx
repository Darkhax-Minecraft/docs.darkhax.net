...
sidebar:
  order: 0
---
import { Link, FileTree } from '../../../components/Components.ts'
...
file on <Link ref="https://github.com/Darkhax-Minecraft/Enchantment-Descriptions/blob/1.20.1/common/src/main/resources/assets/enchdesc/lang/en_us.json">GitHub</Link>.
...
| style                        | \{"color":"dark_gray"\} | Sets the visual style of the description in game. Lear more about styles <Link ref="/minecraft/text/style">here</Link>. |
...
<Link ref="https://docs.darkhax.net/assets/enchantment_descriptions/Enchantment-Descriptions-Examples-1.0.0.zip">here</Link>
. If you are a mod developer adding support in your own mod, you should use your mods pre-existing resource pack.
