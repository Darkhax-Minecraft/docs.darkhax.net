...
sidebar:
  order: 902
---
import { CardGrid, ModCard} from '../../../../../components/Components.ts'
...
|---------------|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| color         | #FF00FF or dark_blue | Sets the color of the text. Supports a hex code or a [Text Color](/minecraft/concepts/text/text_color).                                                 |
