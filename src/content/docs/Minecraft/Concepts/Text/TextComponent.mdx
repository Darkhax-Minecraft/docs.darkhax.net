...
can be found [here](/minecraft/concepts/registries/entries/key-bindings).
...
makes several values like the name of the current player available through its [Extended Text](/bookshelf/extended-text)
