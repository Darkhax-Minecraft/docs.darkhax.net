...
---
import {Link, CardGrid, ModCard} from '../../../../components/Components.js'
...
|---------------|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| color         | #FF00FF or dark_blue | Sets the color of the text. Supports a hex code or a <Link ref="/minecraft/text/textcolor">TextColor</Link>.                                            |
